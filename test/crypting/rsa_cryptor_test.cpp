...
#if USE_BORINGSSL
  EVP_EncryptInit_ex(rsa_enc_ctx, EVP_aes_256_cbc(), ek, ek_len, *iv, &keypair, 1);
  EVP_EncryptUpdate(rsa_enc_ctx, *cipher, &block_len, (unsigned char*) msg256, msg256_len);
...
#if USE_BORINGSSL
  EVP_DecryptInit_ex(rsa_dec_ctx, EVP_aes_256_cbc(), ek, ek_len, iv, keypair);
